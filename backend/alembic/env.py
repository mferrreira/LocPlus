...
# 1. Carregar as senhas do nosso cofre seguro (.env)
load_dotenv()
...
# 3. Injetar a URL do banco de dados dinamicamente puxando do .env
config.set_main_option("sqlalchemy.url", os.getenv("DATABASE_URL"))

if config.config_file_name is not None:
    fileConfig(config.config_file_name)

# 4. Apontar para os metadados das nossas tabelas
