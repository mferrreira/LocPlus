...
# 2. Como a locadora cobra por isso?
class TipoCobranca(str, enum.Enum):
    DIARIA = "diaria"
    MENSAL = "mensal"
    HORA = "hora"
    FRANQUIA = "franquia" # Ex: Cobra X valor até 100km, depois cobra por km
...
class Equipamento(Base):
    ...
    valor_base_locacao = Column(Float, nullable=False)
    tipo_cobranca = Column(Enum(TipoCobranca), default=TipoCobranca.DIARIA)
